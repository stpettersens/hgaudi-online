...
HGaudiPlatform.getPlatform = function() {
	var platform = null;
	platform = "JavaScript [";
	if($.browser.webkit) platform += "WebKit-based/" + $.browser.version; else if($.browser.opera) platform += "Opera/" + $.browser.version; else if($.browser.msie) platform += "MSIE/" + $.browser.version; else if($.browser.mozilla) platform += "Firefox/" + $.browser.version;
	platform += "]";
	return " (" + platform + ")";
}
